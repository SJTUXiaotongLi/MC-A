...
public:
	Parameter(const std::string name_spec, const std::string type_spec, bool print_option_spec, const std::string numerical_condition_type_spec = "N/A", double bound_spec = 0) 
	: name(name_spec), type(type_spec), numerical_condition_type(numerical_condition_type_spec), val_set(false), val_int(3), val_dbl(3.141593), val_str("pi"), bound_int(bound_spec), bound_dbl(bound_spec), print_option(print_option_spec) {
...
public:
	ParameterBundle(std::string input_file, bool print_option_spec = false) 
	: print_option(print_option_spec) { init(input_file); };
...
class SomeLatticeParameterBundle : public ParameterBundle {
public:
	SomeLatticeParameterBundle(std::string input_file, bool print_option_spec = false) : ParameterBundle(print_option_spec) {
		init(input_file);
	};
